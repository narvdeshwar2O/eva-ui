<template>
 ...
 <span class="text-blue-950">Material Details</span>
 </nav>
 ...
 <p class="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-4">Material Information</p>
 <div class="space-y-4">
 <div class="flex justify-between items-center border-b border-blue-100 pb-2">
 <span class="text-[11px] font-bold text-blue-500 uppercase">Title</span>
 <span class="text-sm font-black text-blue-950">{{ material.title }}</span>
 </div>
 <div class="flex justify-between items-center border-b border-blue-100 pb-2">
 <span class="text-[11px] font-bold text-blue-500 uppercase">File</span>
 <div class="flex items-center gap-2 p-1 bg-white border border-blue-100 rounded-lg">
 <feather type="file" size="12" class="text-blue-600"></feather>
 <span class="text-[9px] font-black text-blue-900 uppercase tracking-tighter">PDF DOCUMENT</span>
 </div>
 </div>
 <div class="p-4 bg-white rounded-xl border border-blue-100">
 <p class="text-[11px] font-bold text-blue-500 uppercase mb-2">Description</p>
 <p class="text-xs font-medium text-blue-700 leading-relaxed">{{ material.description || 'No description available.' }}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div class="space-y-6">
 <div class="p-6 rounded-2xl bg-blue-50/50 border border-blue-100">
 <p class="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-4">Actions</p>
 <div class="space-y-4">
 <button 
 @click="$emit('edit', material)"
 class="w-fit mx-auto sm:mx-0 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-blue-950 text-white text-[11px] font-black uppercase tracking-widest hover:bg-blue-900 transition-all shadow-lg"
 >
 ...
 <span class="text-[11px] font-bold text-blue-500 uppercase tracking-widest">Internal ID</span>
 <span class="text-xs font-mono text-indigo-400">#MAT-{{ material.id }}</span>
 </div>
 </div>
 </div>
 </div>
