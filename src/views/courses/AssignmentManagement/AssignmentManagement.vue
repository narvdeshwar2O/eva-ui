<template>
 ...
 <feather type="chevron-right" size="8"></feather>
 <span class="text-blue-950">Assignments Management</span>
 </nav>
 <h2 class="text-2xl font-black text-blue-950 tracking-tight">Assignments Management</h2>
 </div>
 ...
 <h3 class="text-lg font-black text-blue-950 tracking-tight">Assignments</h3>
 ...
 class="w-full h-10 pl-10 pr-4 rounded-xl bg-blue-50 border border-blue-200 text-xs focus:outline-none focus:border-blue-600 focus:bg-white transition-all text-blue-950 font-semibold shadow-inner"
 />
 ...
 <th v-for="head in ['S. No.', 'Title', 'File', 'Created At', 'Actions']" :key="head" class="px-5 py-3 text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">
 ...
 <td colspan="5" class="px-5 py-12 text-center text-indigo-400 font-bold text-sm bg-blue-50/20">
 No data available in table
 </td>
 </tr>
 <tr v-for="(item, index) in assignments" :key="item.id" class="group hover:bg-blue-50/40 transition-all duration-300">
 ...
 <span class="text-[9px] font-black text-blue-900 uppercase tracking-tighter">{{ item.file_type }}</span>
 </div>
 </td>
 <td class="px-5 py-3 text-[11px] font-normal text-blue-500">{{ item.created_at }}</td>
 <td class="px-5 py-3">
 ...
 <span class="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Showing {{ assignments.length ? '1' : '0' }} to {{ assignments.length }} of {{ assignments.length }} entries</span>
...
export default {
 ...
 return {
 assignments: [
 { id: 1, title: 'Python Basics Quiz', file_type: 'PDF', created_at: '10/03/2026 11:20 AM', course_id: 1, marks: 50, startDate: '2026-03-10', endDate: '2026-03-15', description: 'Basic python variables and syntax quiz.' },
 { id: 2, title: 'Java Oops Concepts', file_type: 'PNG', created_at: '11/03/2026 02:45 PM', course_id: 2, marks: 100, startDate: '2026-03-11', endDate: '2026-03-20', description: 'Detailed assignment on inheritance and polymorphism.' },
 { id: 3, title: 'Vue.js Component Lifecycle', file_type: 'JPEG', created_at: '12/03/2026 09:15 AM', course_id: 3, marks: 75, startDate: '2026-03-12', endDate: '2026-03-18', description: 'Practical task on lifecycle hooks.' }
 ],
 ...
 this.$emit('edit-assignment', item);
 },
 handleView(item) {
 this.activeActionIndex = null;
 this.$emit('view-assignment', item);
 },
 handleDelete(id) {
 this.activeActionIndex = null;
